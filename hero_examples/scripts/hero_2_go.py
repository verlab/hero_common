...
class HeroDemo(object):
    ...
    def __init__(self):
        ...
        self.pub_cmd = rospy.Publisher("/hero_2/velocity_controller/cmd_vel", Twist, queue_size=1)
        self.pub_color = rospy.Publisher("/hero_2/led", ColorRGBA, queue_size=1)
        rospy.Subscriber("/hero_0/ground_pose", Pose2D, self.gt_pose_cb)
