...
namespace variant_msgs
{
  ...
  class Test : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = builtin_int_vector_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < builtin_int_vector_length; i++){
      union {
        int32_t real;
        uint32_t base;
      ...
      *(outbuffer + offset++) = string_vector_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < string_vector_length; i++){
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint8_t builtin_int_vector_lengthT = *(inbuffer + offset++);
      ...
      uint8_t string_vector_lengthT = *(inbuffer + offset++);
