...
namespace joint_states_settler
{
  ...
  class ConfigActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "joint_states_settler/ConfigActionGoal"; };
    virtual const char * getMD5() override { return "f19566577bee3cc11a5cee78c14228fe"; };
