...
namespace teleop_tools_msgs
{
  ...
  class IncrementGoal : public ros::Msg
  {
    ...
    IncrementGoal():
      increment_by_length(0), st_increment_by(), increment_by(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "teleop_tools_msgs/IncrementGoal"; };
    virtual const char * getMD5() override { return "6801194f49dae2bee5b8f17b6ce4596f"; };
