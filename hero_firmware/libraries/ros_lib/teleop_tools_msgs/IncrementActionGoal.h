...
namespace teleop_tools_msgs
{
  ...
  class IncrementActionGoal : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "teleop_tools_msgs/IncrementActionGoal"; };
    virtual const char * getMD5() override { return "fd0f65b046bd08324be539043a8c21f7"; };
