...
#include <hero_driver/Proximity.h>
#include <hero_driver/Led.h>
...
#define ID 3
#if ID == 1
  #define GAMMA_GAIN_MOTORS 0.0
  #define WHEEL_R_MID 1540 // Neutral position of right motor
...
void led_cb(const hero_driver::Led& msg);

ros::Subscriber<geometry_msgs::Twist> velocity_sub(VELOCITY_TOPIC, velocity_cb);
ros::Subscriber<hero_driver::Led> led_sub(LED_TOPIC, led_cb);

hero_driver::Proximity proximity_msg;
