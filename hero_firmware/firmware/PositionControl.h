...
class PositionControl {
  private:
    ...
    String heroName;        /* ros namespace */
    /* Command Velocity-Position Callback */
    String cmdvelTopic;                                                 /* Topic name */
    ros::Subscriber<geometry_msgs::Twist, PositionControl> *cmdvelSub;  /* Message type */
    /* Set PID parameters on both motors */
    ros::ServiceServer<hero_common::SetPID::Request, hero_common::SetPID::Response, PositionControl> *setPIDService;    /* Service Type */
    String setPIDTopic;                                                                                                 /* Service name */
    /* Autotune pid for motors */
    ros::ServiceServer<std_srvs::Trigger::Request, std_srvs::Trigger::Response, PositionControl> *pidCalibrationService;/* Service Type */
    ...
    struct PID_CONFIG configPosPID;
  ...
  public:
    PositionControl(unsigned long rate);
